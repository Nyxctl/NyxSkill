---
name: Test Plan
description: "Define test scope, risks, environments, fixtures, cases, automation layers, and release exit criteria."
id: nyx.product.test-plan
version: 1.0.0
---
# Test Plan

## Purpose
Define test scope, risks, environments, fixtures, cases, automation layers, and release exit criteria.

## When to Use
Use when the request matches: test plan, qa plan.
...
2. Apply this skill's focus: Define test scope, risks, environments, fixtures, cases, automation layers, and release exit criteria.
