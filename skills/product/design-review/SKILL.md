---
name: Design Review
description: "Review product and interface designs against goals, flows, consistency, accessibility, feasibility, and edge cases."
id: nyx.product.design-review
version: 1.0.0
---
# Design Review

## Purpose
Review product and interface designs against goals, flows, consistency, accessibility, feasibility, and edge cases.

## When to Use
Use when the request matches: design review, ux review.
...
2. Apply this skill's focus: Review product and interface designs against goals, flows, consistency, accessibility, feasibility, and edge cases.
