...
description: "Create a repeatable release runbook with prerequisites, rollout, observability, rollback, ownership, and recovery."
id: nyx.product.release-runbook
version: 1.0.0
---
# Release Runbook

## Purpose
Create a repeatable release runbook with prerequisites, rollout, observability, rollback, ownership, and recovery.

## When to Use
Use when the request matches: release runbook, launch checklist.
...
2. Apply this skill's focus: Create a repeatable release runbook with prerequisites, rollout, observability, rollback, ownership, and recovery.
