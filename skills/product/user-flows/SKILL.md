---
name: User Flows
description: "Map user goals into screens, decisions, alternate paths, errors, and completion states."
id: nyx.product.user-flows
version: 1.0.0
---
# User Flows

## Purpose
Map user goals into screens, decisions, alternate paths, errors, and completion states.

## When to Use
Use when the request matches: user flow, journey, interaction flow.
...
2. Apply this skill's focus: Map user goals into screens, decisions, alternate paths, errors, and completion states.
