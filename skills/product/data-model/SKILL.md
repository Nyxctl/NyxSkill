---
name: Data Model
description: "Design data entities, relationships, invariants, lifecycle, indexing, migration, and ownership."
id: nyx.product.data-model
version: 1.0.0
---
# Data Model

## Purpose
Design data entities, relationships, invariants, lifecycle, indexing, migration, and ownership.

## When to Use
Use when the request matches: data model, schema design, database model.
...
2. Apply this skill's focus: Design data entities, relationships, invariants, lifecycle, indexing, migration, and ownership.
