...
description: "Produce an implementable technical design with boundaries, interfaces, data flow, failure handling, security, and tests."
id: nyx.product.technical-design
version: 1.0.0
---
# Technical Design

## Purpose
Produce an implementable technical design with boundaries, interfaces, data flow, failure handling, security, and tests.

## When to Use
Use when the request matches: technical design, system design.
...
2. Apply this skill's focus: Produce an implementable technical design with boundaries, interfaces, data flow, failure handling, security, and tests.
