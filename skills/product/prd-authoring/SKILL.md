---
name: Prd Authoring
description: "Write a decision-ready product requirements document with problem, users, scope, success metrics, risks, and non-goals."
id: nyx.product.prd-authoring
version: 1.0.0
---
# Prd Authoring

## Purpose
Write a decision-ready product requirements document with problem, users, scope, success metrics, risks, and non-goals.

## When to Use
Use when the request matches: prd, product requirements.
...
2. Apply this skill's focus: Write a decision-ready product requirements document with problem, users, scope, success metrics, risks, and non-goals.
