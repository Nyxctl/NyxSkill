...
description: "Document system structure, responsibilities, dependencies, data flow, constraints, and evolution paths."
id: nyx.product.architecture-doc
version: 1.0.0
---
# Architecture Doc

## Purpose
Document system structure, responsibilities, dependencies, data flow, constraints, and evolution paths.

## When to Use
Use when the request matches: architecture, architecture doc.
...
2. Apply this skill's focus: Document system structure, responsibilities, dependencies, data flow, constraints, and evolution paths.
