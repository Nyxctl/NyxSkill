---
name: Ml Prior Art
description: "Survey comparable ML techniques, datasets, metrics, compute assumptions, and evaluation protocols."
id: nyx.data-ai.ml-prior-art
version: 1.0.0
---
# Ml Prior Art

## Purpose
Survey comparable ML techniques, datasets, metrics, compute assumptions, and evaluation protocols.

## When to Use
Use when the request matches: ml prior art, machine learning prior art.
...
2. Apply this skill's focus: Survey comparable ML techniques, datasets, metrics, compute assumptions, and evaluation protocols.
