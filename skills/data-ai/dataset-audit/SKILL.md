---
name: Dataset Audit
description: "Audit dataset provenance, schema, labels, leakage, imbalance, duplicates, missingness, splits, and representativeness."
id: nyx.data-ai.dataset-audit
version: 1.0.0
---
# Dataset Audit

## Purpose
Audit dataset provenance, schema, labels, leakage, imbalance, duplicates, missingness, splits, and representativeness.

## When to Use
Use when the request matches: dataset, data quality, label audit.
...
2. Apply this skill's focus: Audit dataset provenance, schema, labels, leakage, imbalance, duplicates, missingness, splits, and representativeness.
