...
description: "Design reproducible ML experiments with clean splits, baselines, ablations, seeds, leakage controls, and decision-oriented metrics."
id: nyx.data-ai.ml-experiment-design
version: 1.0.0
---
# Ml Experiment Design

## Purpose
Design reproducible ML experiments with clean splits, baselines, ablations, seeds, leakage controls, and decision-oriented metrics.

## When to Use
Use when the request matches: ml experiment, experiment design, training protocol.
...
2. Apply this skill's focus: Design reproducible ML experiments with clean splits, baselines, ablations, seeds, leakage controls, and decision-oriented metrics.
