...
description: "Evaluate models with task-appropriate metrics, uncertainty, error analysis, calibration, baselines, and held-out evidence."
id: nyx.data-ai.model-evaluation
version: 1.0.0
---
# Model Evaluation

## Purpose
Evaluate models with task-appropriate metrics, uncertainty, error analysis, calibration, baselines, and held-out evidence.

## When to Use
Use when the request matches: model evaluation, metrics, validation set, test set.
...
2. Apply this skill's focus: Evaluate models with task-appropriate metrics, uncertainty, error analysis, calibration, baselines, and held-out evidence.
