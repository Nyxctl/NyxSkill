---
name: Web Scraping
description: "Extract web data responsibly with stable selectors, rate awareness, provenance, validation, and reproducible outputs."
id: nyx.research.web-scraping
version: 1.0.0
---
# Web Scraping

## Purpose
Extract web data responsibly with stable selectors, rate awareness, provenance, validation, and reproducible outputs.

## When to Use
Use when the request matches: web scraping, scrape, extract web.
...
2. Apply this skill's focus: Extract web data responsibly with stable selectors, rate awareness, provenance, validation, and reproducible outputs.
