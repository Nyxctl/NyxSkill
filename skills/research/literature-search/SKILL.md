...
description: "Build a focused literature search strategy, collect relevant sources, record queries, and prioritize directly comparable work."
id: nyx.research.literature-search
version: 1.0.0
---
# Literature Search

## Purpose
Build a focused literature search strategy, collect relevant sources, record queries, and prioritize directly comparable work.

## When to Use
Use when the request matches: literature, papers, related work.
...
2. Apply this skill's focus: Build a focused literature search strategy, collect relevant sources, record queries, and prioritize directly comparable work.
