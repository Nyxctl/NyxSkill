...
description: "Survey prior art systematically, compare approaches and constraints, and identify meaningful novelty gaps."
id: nyx.research.prior-art-survey
version: 1.0.0
---
# Prior Art Survey

## Purpose
Survey prior art systematically, compare approaches and constraints, and identify meaningful novelty gaps.

## When to Use
Use when the request matches: prior art, existing solutions, competitive research.
...
2. Apply this skill's focus: Survey prior art systematically, compare approaches and constraints, and identify meaningful novelty gaps.
