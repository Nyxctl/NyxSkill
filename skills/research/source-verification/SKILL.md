...
description: "Verify claims against primary or authoritative sources, track uncertainty, and distinguish evidence from inference."
id: nyx.research.source-verification
version: 1.0.0
---
# Source Verification

## Purpose
Verify claims against primary or authoritative sources, track uncertainty, and distinguish evidence from inference.

## When to Use
Use when the request matches: verify source, fact check, source verification.
...
2. Apply this skill's focus: Verify claims against primary or authoritative sources, track uncertainty, and distinguish evidence from inference.
