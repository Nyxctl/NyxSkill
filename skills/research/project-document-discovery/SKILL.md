...
description: "Discover relevant project documents, rank likely sources, inspect freshness, and build a traceable evidence set."
id: nyx.research.project-document-discovery
version: 1.0.0
---
# Project Document Discovery

## Purpose
Discover relevant project documents, rank likely sources, inspect freshness, and build a traceable evidence set.

## When to Use
Use when the request matches: find docs, project documents, document discovery.
...
2. Apply this skill's focus: Discover relevant project documents, rank likely sources, inspect freshness, and build a traceable evidence set.
