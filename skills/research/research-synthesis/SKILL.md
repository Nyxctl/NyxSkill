...
description: "Synthesize multiple sources by question, method, evidence strength, agreement, disagreement, and unresolved gaps."
id: nyx.research.research-synthesis
version: 1.0.0
---
# Research Synthesis

## Purpose
Synthesize multiple sources by question, method, evidence strength, agreement, disagreement, and unresolved gaps.

## When to Use
Use when the request matches: research synthesis, synthesize sources.
...
2. Apply this skill's focus: Synthesize multiple sources by question, method, evidence strength, agreement, disagreement, and unresolved gaps.
