---
name: Secure Auth
description: "Design and review authentication/session flows, token handling, redirects, storage, expiry, revocation, and authorization boundaries."
id: nyx.security.secure-auth
version: 1.0.0
---
# Secure Auth

## Purpose
Design and review authentication/session flows, token handling, redirects, storage, expiry, revocation, and authorization boundaries.

## When to Use
Use when the request matches: auth, oauth, login, session, token.
...
2. Apply this skill's focus: Design and review authentication/session flows, token handling, redirects, storage, expiry, revocation, and authorization boundaries.
