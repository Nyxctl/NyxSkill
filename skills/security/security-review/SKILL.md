...
description: "Review attack surface, trust boundaries, data exposure, validation, secrets, authorization, dependencies, and abuse cases."
id: nyx.security.security-review
version: 1.0.0
---
# Security Review

## Purpose
Review attack surface, trust boundaries, data exposure, validation, secrets, authorization, dependencies, and abuse cases.

## When to Use
Use when the request matches: security, vulnerability, threat model.
...
2. Apply this skill's focus: Review attack surface, trust boundaries, data exposure, validation, secrets, authorization, dependencies, and abuse cases.
