...
description: "Run a structured application security checklist and separate blocking findings from hardening opportunities."
id: nyx.security.security-checklist
version: 1.0.0
---
# Security Checklist

## Purpose
Run a structured application security checklist and separate blocking findings from hardening opportunities.

## When to Use
Use when the request matches: security checklist, security audit.
...
2. Apply this skill's focus: Run a structured application security checklist and separate blocking findings from hardening opportunities.
