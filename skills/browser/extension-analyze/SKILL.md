...
description: "Analyze an existing browser extension for architecture, permissions, security, compatibility, and maintainability."
id: nyx.browser.extension-analyze
version: 1.0.0
---
# Extension Analyze

## Purpose
Analyze an existing browser extension for architecture, permissions, security, compatibility, and maintainability.

## When to Use
Use when the request matches: extension, analyze.
...
2. Apply this skill's focus: Analyze an existing browser extension for architecture, permissions, security, compatibility, and maintainability.
