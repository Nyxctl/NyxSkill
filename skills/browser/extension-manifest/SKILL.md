...
description: "Design and review Manifest V3 permissions, host access, service workers, CSP, commands, content scripts, and browser compatibility."
id: nyx.browser.extension-manifest
version: 1.0.0
---
# Extension Manifest

## Purpose
Design and review Manifest V3 permissions, host access, service workers, CSP, commands, content scripts, and browser compatibility.

## When to Use
Use when the request matches: extension, manifest.
...
2. Apply this skill's focus: Design and review Manifest V3 permissions, host access, service workers, CSP, commands, content scripts, and browser compatibility.
