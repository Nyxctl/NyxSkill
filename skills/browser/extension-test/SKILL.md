---
name: Extension Test
description: "Test background/service-worker logic, content scripts, messaging, permissions, storage, UI, and browser integration."
id: nyx.browser.extension-test
version: 1.0.0
---
# Extension Test

## Purpose
Test background/service-worker logic, content scripts, messaging, permissions, storage, UI, and browser integration.

## When to Use
Use when the request matches: extension, test.
...
2. Apply this skill's focus: Test background/service-worker logic, content scripts, messaging, permissions, storage, UI, and browser integration.
