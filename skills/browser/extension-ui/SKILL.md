---
name: Extension Ui
description: "Design extension popup, options, side panel, onboarding, and in-page UI for constrained browser surfaces."
id: nyx.browser.extension-ui
version: 1.0.0
---
# Extension Ui

## Purpose
Design extension popup, options, side panel, onboarding, and in-page UI for constrained browser surfaces.

## When to Use
Use when the request matches: extension, ui.
...
2. Apply this skill's focus: Design extension popup, options, side panel, onboarding, and in-page UI for constrained browser surfaces.
