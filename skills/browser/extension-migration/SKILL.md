...
description: "Plan and execute extension migrations while preserving data, permissions, compatibility, and rollback paths."
id: nyx.browser.extension-migration
version: 1.0.0
---
# Extension Migration

## Purpose
Plan and execute extension migrations while preserving data, permissions, compatibility, and rollback paths.

## When to Use
Use when the request matches: extension, migration.
...
2. Apply this skill's focus: Plan and execute extension migrations while preserving data, permissions, compatibility, and rollback paths.
