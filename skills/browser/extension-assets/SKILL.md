...
description: "Prepare icons, store images, public assets, and packaging paths that satisfy browser-store requirements."
id: nyx.browser.extension-assets
version: 1.0.0
---
# Extension Assets

## Purpose
Prepare icons, store images, public assets, and packaging paths that satisfy browser-store requirements.

## When to Use
Use when the request matches: extension, assets.
...
2. Apply this skill's focus: Prepare icons, store images, public assets, and packaging paths that satisfy browser-store requirements.
