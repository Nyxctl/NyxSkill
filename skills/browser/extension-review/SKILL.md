...
description: "Perform a release-focused extension review covering correctness, security, permissions, privacy, UX, and store compliance."
id: nyx.browser.extension-review
version: 1.0.0
---
# Extension Review

## Purpose
Perform a release-focused extension review covering correctness, security, permissions, privacy, UX, and store compliance.

## When to Use
Use when the request matches: extension, review.
...
2. Apply this skill's focus: Perform a release-focused extension review covering correctness, security, permissions, privacy, UX, and store compliance.
