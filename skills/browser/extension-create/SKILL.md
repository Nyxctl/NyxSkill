...
description: "Create a browser extension foundation with clear manifest, permissions, messaging, storage, build, and testing structure."
id: nyx.browser.extension-create
version: 1.0.0
---
# Extension Create

## Purpose
Create a browser extension foundation with clear manifest, permissions, messaging, storage, build, and testing structure.

## When to Use
Use when the request matches: extension, create.
...
2. Apply this skill's focus: Create a browser extension foundation with clear manifest, permissions, messaging, storage, build, and testing structure.
