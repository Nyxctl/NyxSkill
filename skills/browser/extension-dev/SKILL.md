---
name: Extension Dev
description: "Implement browser-extension behavior while respecting extension lifecycle, isolated worlds, messaging, storage, and browser APIs."
id: nyx.browser.extension-dev
version: 1.0.0
---
# Extension Dev

## Purpose
Implement browser-extension behavior while respecting extension lifecycle, isolated worlds, messaging, storage, and browser APIs.

## When to Use
Use when the request matches: extension, dev.
...
2. Apply this skill's focus: Implement browser-extension behavior while respecting extension lifecycle, isolated worlds, messaging, storage, and browser APIs.
