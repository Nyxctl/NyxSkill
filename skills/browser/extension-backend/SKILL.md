...
description: "Design backend services used by an extension with secure authentication, API boundaries, rate limits, and resilient client behavior."
id: nyx.browser.extension-backend
version: 1.0.0
---
# Extension Backend

## Purpose
Design backend services used by an extension with secure authentication, API boundaries, rate limits, and resilient client behavior.

## When to Use
Use when the request matches: extension, backend.
...
2. Apply this skill's focus: Design backend services used by an extension with secure authentication, API boundaries, rate limits, and resilient client behavior.
