...
description: "Write clear academic prose that distinguishes method, evidence, results, limitations, and claims without overstating findings."
id: nyx.academic.academic-writing
version: 1.0.0
---
# Academic Writing

## Purpose
Write clear academic prose that distinguishes method, evidence, results, limitations, and claims without overstating findings.

## When to Use
Use when the request matches: academic writing, paper writing, manuscript.
...
2. Apply this skill's focus: Write clear academic prose that distinguishes method, evidence, results, limitations, and claims without overstating findings.
