...
description: "Review a manuscript strictly but fairly across clarity, novelty, methodology, experiments, evidence, citations, and reproducibility."
id: nyx.academic.reviewer-workflow
version: 1.0.0
---
# Reviewer Workflow

## Purpose
Review a manuscript strictly but fairly across clarity, novelty, methodology, experiments, evidence, citations, and reproducibility.

## When to Use
Use when the request matches: reviewer, peer review, paper reviewer.
...
2. Apply this skill's focus: Review a manuscript strictly but fairly across clarity, novelty, methodology, experiments, evidence, citations, and reproducibility.
