---
name: Citation Audit
description: "Audit whether citations support nearby claims, are complete and consistent, and distinguish background from direct evidence."
id: nyx.academic.citation-audit
version: 1.0.0
---
# Citation Audit

## Purpose
Audit whether citations support nearby claims, are complete and consistent, and distinguish background from direct evidence.

## When to Use
Use when the request matches: citation, references, bibliography.
...
2. Apply this skill's focus: Audit whether citations support nearby claims, are complete and consistent, and distinguish background from direct evidence.
