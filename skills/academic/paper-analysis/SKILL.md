---
name: Paper Analysis
description: "Analyze a paper by problem, method, data, baselines, metrics, results, limitations, and relevance to the target work."
id: nyx.academic.paper-analysis
version: 1.0.0
---
# Paper Analysis

## Purpose
Analyze a paper by problem, method, data, baselines, metrics, results, limitations, and relevance to the target work.

## When to Use
Use when the request matches: analyze paper, paper review, read paper.
...
2. Apply this skill's focus: Analyze a paper by problem, method, data, baselines, metrics, results, limitations, and relevance to the target work.
