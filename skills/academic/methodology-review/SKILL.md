...
description: "Review methodological validity, leakage risk, baselines, metrics, reproducibility, statistical support, and claim alignment."
id: nyx.academic.methodology-review
version: 1.0.0
---
# Methodology Review

## Purpose
Review methodological validity, leakage risk, baselines, metrics, reproducibility, statistical support, and claim alignment.

## When to Use
Use when the request matches: methodology, experimental design, methods review.
...
2. Apply this skill's focus: Review methodological validity, leakage risk, baselines, metrics, reproducibility, statistical support, and claim alignment.
