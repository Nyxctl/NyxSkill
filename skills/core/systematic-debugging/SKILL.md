...
description: "Find root cause before changing behavior, using reproducible evidence and hypothesis-driven checks."
id: nyx.core.systematic-debugging
version: 1.0.0
---
# Systematic Debugging

## Purpose
Find root cause before changing behavior, using reproducible evidence and hypothesis-driven checks.

## When to Use
Use when the request matches: bug, crash, broken, broke, regression, error, failure.
...
2. Apply this skill's focus: Find root cause before changing behavior, using reproducible evidence and hypothesis-driven checks.
