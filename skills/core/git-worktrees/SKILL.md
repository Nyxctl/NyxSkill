---
name: Git Worktrees
description: "Create or verify an isolated Git workspace before substantial implementation when branch safety matters."
id: nyx.core.git-worktrees
version: 1.0.0
---
# Git Worktrees

## Purpose
Create or verify an isolated Git workspace before substantial implementation when branch safety matters.

## When to Use
Use when the request matches: worktree, isolated branch, git branch.
...
2. Apply this skill's focus: Create or verify an isolated Git workspace before substantial implementation when branch safety matters.
