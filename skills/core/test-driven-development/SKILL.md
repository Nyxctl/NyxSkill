...
description: "Implement behavior through red-green-refactor with tests that fail for the intended reason before production changes."
id: nyx.core.test-driven-development
version: 1.0.0
---
# Test Driven Development

## Purpose
Implement behavior through red-green-refactor with tests that fail for the intended reason before production changes.

## When to Use
Use when the request matches: tdd, test first, implement feature, bugfix.
...
2. Apply this skill's focus: Implement behavior through red-green-refactor with tests that fail for the intended reason before production changes.
