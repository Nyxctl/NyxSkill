---
name: Brainstorming
description: "Explore intent, constraints, alternatives, and trade-offs before committing to a design."
id: nyx.core.brainstorming
version: 1.0.0
---
# Brainstorming

## Purpose
Explore intent, constraints, alternatives, and trade-offs before committing to a design.

## When to Use
Use when the request matches: brainstorm, design, idea, requirements.
...
2. Apply this skill's focus: Explore intent, constraints, alternatives, and trade-offs before committing to a design.
