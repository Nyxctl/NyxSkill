---
name: Verification
description: "Verify claims with fresh commands or evidence before completion and report exactly what passed or remains blocked."
id: nyx.core.verification
version: 1.0.0
---
# Verification

## Purpose
Verify claims with fresh commands or evidence before completion and report exactly what passed or remains blocked.

## When to Use
Use when the request matches: verify, verification, done, complete.
...
2. Apply this skill's focus: Verify claims with fresh commands or evidence before completion and report exactly what passed or remains blocked.
