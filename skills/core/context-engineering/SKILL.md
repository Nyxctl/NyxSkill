...
description: "Structure working context so agents receive the minimum complete information needed for reliable execution."
id: nyx.core.context-engineering
version: 1.0.0
---
# Context Engineering

## Purpose
Structure working context so agents receive the minimum complete information needed for reliable execution.

## When to Use
Use when the request matches: context, prompt context, token budget.
...
2. Apply this skill's focus: Structure working context so agents receive the minimum complete information needed for reliable execution.
