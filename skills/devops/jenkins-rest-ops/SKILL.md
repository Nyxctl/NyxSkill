...
description: "Inspect and operate Jenkins jobs through controlled REST actions, explicit targets, credentials, and build verification."
id: nyx.devops.jenkins-rest-ops
version: 1.0.0
---
# Jenkins Rest Ops

## Purpose
Inspect and operate Jenkins jobs through controlled REST actions, explicit targets, credentials, and build verification.

## When to Use
Use when the request matches: jenkins, jenkins api.
...
2. Apply this skill's focus: Inspect and operate Jenkins jobs through controlled REST actions, explicit targets, credentials, and build verification.
