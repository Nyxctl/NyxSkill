...
description: "Review deployment target, environment differences, migrations, secrets, health checks, observability, rollback, and blast radius."
id: nyx.devops.deployment-review
version: 1.0.0
---
# Deployment Review

## Purpose
Review deployment target, environment differences, migrations, secrets, health checks, observability, rollback, and blast radius.

## When to Use
Use when the request matches: deploy, deployment, production.
...
2. Apply this skill's focus: Review deployment target, environment differences, migrations, secrets, health checks, observability, rollback, and blast radius.
