---
name: Netlify Ops
description: "Operate Netlify deployments with build configuration, previews, environment variables, redirects, domains, and rollback checks."
id: nyx.devops.netlify-ops
version: 1.0.0
---
# Netlify Ops

## Purpose
Operate Netlify deployments with build configuration, previews, environment variables, redirects, domains, and rollback checks.

## When to Use
Use when the request matches: netlify, netlify deploy.
...
2. Apply this skill's focus: Operate Netlify deployments with build configuration, previews, environment variables, redirects, domains, and rollback checks.
