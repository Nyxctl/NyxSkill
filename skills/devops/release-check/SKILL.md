---
name: Release Check
description: "Run pre-release quality, compatibility, security, artifact, changelog, versioning, and rollback checks before publishing."
id: nyx.devops.release-check
version: 1.0.0
---
# Release Check

## Purpose
Run pre-release quality, compatibility, security, artifact, changelog, versioning, and rollback checks before publishing.

## When to Use
Use when the request matches: release, ship, release check.
...
2. Apply this skill's focus: Run pre-release quality, compatibility, security, artifact, changelog, versioning, and rollback checks before publishing.
