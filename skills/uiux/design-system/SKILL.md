---
name: Design System
description: "Define reusable visual tokens, components, states, usage rules, accessibility expectations, and governance."
id: nyx.uiux.design-system
version: 1.0.0
---
# Design System

## Purpose
Define reusable visual tokens, components, states, usage rules, accessibility expectations, and governance.

## When to Use
Use when the request matches: design system, tokens, components.
...
2. Apply this skill's focus: Define reusable visual tokens, components, states, usage rules, accessibility expectations, and governance.
