---
name: Hi Fi
description: "Create or review high-fidelity UI details with consistent typography, spacing, color, states, responsiveness, and accessibility."
id: nyx.uiux.hi-fi
version: 1.0.0
---
# Hi Fi
...
## Purpose
Create or review high-fidelity UI details with consistent typography, spacing, color, states, responsiveness, and accessibility.

## When to Use
Use when the request matches: high fidelity, hi fi, visual design.
...
2. Apply this skill's focus: Create or review high-fidelity UI details with consistent typography, spacing, color, states, responsiveness, and accessibility.
