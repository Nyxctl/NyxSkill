---
name: Wireframes
description: "Create low-fidelity layouts that make information hierarchy, navigation, states, and interaction paths testable early."
id: nyx.uiux.wireframes
version: 1.0.0
---
# Wireframes

## Purpose
Create low-fidelity layouts that make information hierarchy, navigation, states, and interaction paths testable early.

## When to Use
Use when the request matches: wireframe, low fidelity.
...
2. Apply this skill's focus: Create low-fidelity layouts that make information hierarchy, navigation, states, and interaction paths testable early.
