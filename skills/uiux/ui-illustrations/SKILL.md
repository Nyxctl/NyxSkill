...
description: "Plan and integrate UI illustrations with clear purpose, sizing, accessibility, performance, and responsive behavior."
id: nyx.uiux.ui-illustrations
version: 1.0.0
---
# Ui Illustrations

## Purpose
Plan and integrate UI illustrations with clear purpose, sizing, accessibility, performance, and responsive behavior.

## When to Use
Use when the request matches: illustration, ui artwork.
...
2. Apply this skill's focus: Plan and integrate UI illustrations with clear purpose, sizing, accessibility, performance, and responsive behavior.
