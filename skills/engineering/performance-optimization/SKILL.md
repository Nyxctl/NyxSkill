...
description: "Measure before optimizing, identify bottlenecks, and validate performance gains without correctness regressions."
id: nyx.engineering.performance-optimization
version: 1.0.0
---
# Performance Optimization

## Purpose
Measure before optimizing, identify bottlenecks, and validate performance gains without correctness regressions.

## When to Use
Use when the request matches: performance, slow, latency, memory.
...
2. Apply this skill's focus: Measure before optimizing, identify bottlenecks, and validate performance gains without correctness regressions.
