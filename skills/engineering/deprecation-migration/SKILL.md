...
description: "Plan staged migrations with compatibility windows, telemetry, rollback, and clear consumer guidance."
id: nyx.engineering.deprecation-migration
version: 1.0.0
---
# Deprecation Migration

## Purpose
Plan staged migrations with compatibility windows, telemetry, rollback, and clear consumer guidance.

## When to Use
Use when the request matches: deprecation, migration, breaking change.
...
2. Apply this skill's focus: Plan staged migrations with compatibility windows, telemetry, rollback, and clear consumer guidance.
