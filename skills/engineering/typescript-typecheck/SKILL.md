...
description: "Use TypeScript diagnostics systematically to isolate type failures and validate fixes with project-native commands."
id: nyx.engineering.typescript-typecheck
version: 1.0.0
---
# Typescript Typecheck

## Purpose
Use TypeScript diagnostics systematically to isolate type failures and validate fixes with project-native commands.

## When to Use
Use when the request matches: typescript, typecheck, tsc.
...
2. Apply this skill's focus: Use TypeScript diagnostics systematically to isolate type failures and validate fixes with project-native commands.
