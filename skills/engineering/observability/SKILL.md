---
name: Observability
description: "Design useful logs, metrics, traces, and operational signals around failure modes and user outcomes."
id: nyx.engineering.observability
version: 1.0.0
---
# Observability

## Purpose
Design useful logs, metrics, traces, and operational signals around failure modes and user outcomes.

## When to Use
Use when the request matches: observability, logging, metrics, tracing.
...
2. Apply this skill's focus: Design useful logs, metrics, traces, and operational signals around failure modes and user outcomes.
