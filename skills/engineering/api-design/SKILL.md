---
name: Api Design
description: "Design stable, evolvable APIs and interfaces with explicit contracts, errors, compatibility, and examples."
id: nyx.engineering.api-design
version: 1.0.0
---
# Api Design

## Purpose
Design stable, evolvable APIs and interfaces with explicit contracts, errors, compatibility, and examples.

## When to Use
Use when the request matches: api, interface, endpoint.
...
2. Apply this skill's focus: Design stable, evolvable APIs and interfaces with explicit contracts, errors, compatibility, and examples.
