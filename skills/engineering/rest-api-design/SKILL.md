...
description: "Design REST resources, methods, status codes, pagination, idempotency, errors, and versioning coherently."
id: nyx.engineering.rest-api-design
version: 1.0.0
---
# Rest Api Design

## Purpose
Design REST resources, methods, status codes, pagination, idempotency, errors, and versioning coherently.

## When to Use
Use when the request matches: rest, rest api, resource api.
...
2. Apply this skill's focus: Design REST resources, methods, status codes, pagination, idempotency, errors, and versioning coherently.
