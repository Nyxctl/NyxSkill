...
description: "Generate and validate TypeScript API clients from OpenAPI contracts while keeping generated and handwritten layers separate."
id: nyx.engineering.openapi-ts-client
version: 1.0.0
---
# Openapi Ts Client

## Purpose
Generate and validate TypeScript API clients from OpenAPI contracts while keeping generated and handwritten layers separate.

## When to Use
Use when the request matches: openapi, typescript client, sdk.
...
2. Apply this skill's focus: Generate and validate TypeScript API clients from OpenAPI contracts while keeping generated and handwritten layers separate.
