...
description: "Test React components through user-observable behavior, state transitions, accessibility, and stable boundaries."
id: nyx.engineering.react-component-testing
version: 1.0.0
---
# React Component Testing

## Purpose
Test React components through user-observable behavior, state transitions, accessibility, and stable boundaries.

## When to Use
Use when the request matches: react, component test, vitest, testing library.
...
2. Apply this skill's focus: Test React components through user-observable behavior, state transitions, accessibility, and stable boundaries.
