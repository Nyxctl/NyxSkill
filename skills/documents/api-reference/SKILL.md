---
name: Api Reference
description: "Write precise API reference material with signatures, parameters, responses, errors, examples, and compatibility notes."
id: nyx.documents.api-reference
version: 1.0.0
---
# Api Reference

## Purpose
Write precise API reference material with signatures, parameters, responses, errors, examples, and compatibility notes.

## When to Use
Use when the request matches: api reference, reference docs.
...
2. Apply this skill's focus: Write precise API reference material with signatures, parameters, responses, errors, examples, and compatibility notes.
