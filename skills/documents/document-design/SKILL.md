...
description: "Design readable reports and documents with consistent hierarchy, spacing, tables, figures, pagination, and accessibility."
id: nyx.documents.document-design
version: 1.0.0
---
# Document Design

## Purpose
Design readable reports and documents with consistent hierarchy, spacing, tables, figures, pagination, and accessibility.

## When to Use
Use when the request matches: document design, report layout.
...
2. Apply this skill's focus: Design readable reports and documents with consistent hierarchy, spacing, tables, figures, pagination, and accessibility.
