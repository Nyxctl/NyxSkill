...
description: "Write a task-oriented developer guide covering setup, architecture, workflows, debugging, testing, and operational caveats."
id: nyx.documents.developer-guide
version: 1.0.0
---
# Developer Guide

## Purpose
Write a task-oriented developer guide covering setup, architecture, workflows, debugging, testing, and operational caveats.

## When to Use
Use when the request matches: developer guide, engineering guide.
...
2. Apply this skill's focus: Write a task-oriented developer guide covering setup, architecture, workflows, debugging, testing, and operational caveats.
