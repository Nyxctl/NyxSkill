---
name: Structured Rewrite
description: "Rewrite while preserving meaning, evidence, terminology constraints, and requested structure or tone."
id: nyx.documents.structured-rewrite
version: 1.0.0
---
# Structured Rewrite

## Purpose
Rewrite while preserving meaning, evidence, terminology constraints, and requested structure or tone.

## When to Use
Use when the request matches: rewrite, restructure, edit document.
...
2. Apply this skill's focus: Rewrite while preserving meaning, evidence, terminology constraints, and requested structure or tone.
