---
name: User Guide
description: "Write user-facing guidance organized around goals, prerequisites, steps, expected results, errors, and recovery."
id: nyx.documents.user-guide
version: 1.0.0
---
# User Guide

## Purpose
Write user-facing guidance organized around goals, prerequisites, steps, expected results, errors, and recovery.

## When to Use
Use when the request matches: user guide, help documentation.
...
2. Apply this skill's focus: Write user-facing guidance organized around goals, prerequisites, steps, expected results, errors, and recovery.
