...
description: "Review documents for structure, consistency, terminology, missing evidence, tables/figures, formatting, and actionability."
id: nyx.documents.document-review
version: 1.0.0
---
# Document Review

## Purpose
Review documents for structure, consistency, terminology, missing evidence, tables/figures, formatting, and actionability.

## When to Use
Use when the request matches: document review, review document, docx, pdf.
...
2. Apply this skill's focus: Review documents for structure, consistency, terminology, missing evidence, tables/figures, formatting, and actionability.
