...
description: "Capture what changed, evidence of outcomes, surprises, root causes, decisions, and concrete improvements for the next cycle."
id: nyx.automation.project-retrospective
version: 1.0.0
---
# Project Retrospective

## Purpose
Capture what changed, evidence of outcomes, surprises, root causes, decisions, and concrete improvements for the next cycle.

## When to Use
Use when the request matches: retrospective, postmortem, lessons learned.
...
2. Apply this skill's focus: Capture what changed, evidence of outcomes, surprises, root causes, decisions, and concrete improvements for the next cycle.
