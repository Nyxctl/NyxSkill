...
description: "Design reliable CI/CD workflows with explicit triggers, caches, quality gates, artifacts, secrets, environments, and rollback."
id: nyx.automation.ci-cd-automation
version: 1.0.0
---
# Ci Cd Automation

## Purpose
Design reliable CI/CD workflows with explicit triggers, caches, quality gates, artifacts, secrets, environments, and rollback.

## When to Use
Use when the request matches: ci, cd, pipeline, github actions.
...
2. Apply this skill's focus: Design reliable CI/CD workflows with explicit triggers, caches, quality gates, artifacts, secrets, environments, and rollback.
