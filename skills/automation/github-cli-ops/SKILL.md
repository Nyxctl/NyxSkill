---
name: Github Cli Ops
description: "Use GitHub CLI workflows carefully for repository inspection, issues, pull requests, checks, releases, and auditable changes."
id: nyx.automation.github-cli-ops
version: 1.0.0
---
# Github Cli Ops

## Purpose
Use GitHub CLI workflows carefully for repository inspection, issues, pull requests, checks, releases, and auditable changes.

## When to Use
Use when the request matches: github cli, gh , pull request, github issue.
...
2. Apply this skill's focus: Use GitHub CLI workflows carefully for repository inspection, issues, pull requests, checks, releases, and auditable changes.
3. Prefer project-native conventions and inspect existing evidence before proposing change.
4. Confirm the exact target and required privileged capability before any external or deployment action.
5. Make the smallest justified decisions or changes, keeping assumptions explicit.
6. Verify the result with concrete evidence appropriate to the task and report unresolved risks.
